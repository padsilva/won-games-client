...
describe('<ExploreSidebar />', () => {
  ...
  it('should render inputs', () => {
    ...
    expect(screen.getByRole('checkbox', { name: /linux/i })).toBeInTheDocument()
  })
  ...
  it('should check the initial values that are passed', () => {
    render(
      <ExploreSidebar
        items={itemsMock}
  ...
  it('should filter with checked values', () => {
    ...
    // 1- render, 2- platform windows, 3- platform linux, 4- sort
